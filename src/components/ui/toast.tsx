...
>;
type ToastViewportRef = React.ElementRef<typeof ToastPrimitives.Viewport>;

const ToastViewport = React.forwardRef<ToastViewportRef, ToastViewportProps>(
  ({ className, ...props }, ref) => (
...
type ToastRootProps = React.ComponentPropsWithoutRef<
...
>;
type ToastActionRef = React.ElementRef<typeof ToastPrimitives.Action>;
...
>;
type ToastCloseRef = React.ElementRef<typeof ToastPrimitives.Close>;

const ToastClose = React.forwardRef<ToastCloseRef, ToastCloseProps>(
  ({ className, ...props }, ref) => (
...
>;
type ToastTitleRef = React.ElementRef<typeof ToastPrimitives.Title>;

const ToastTitle = React.forwardRef<ToastTitleRef, ToastTitleProps>(
  ({ className, ...props }, ref) => (
...
>;
type ToastDescriptionRef = React.ElementRef<typeof ToastPrimitives.Description>;
